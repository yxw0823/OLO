...
<body>
	<form action="olopdcarousel/${msg}.do" name="Form" id="Form" method="post"  enctype="multipart/form-data">
		<input type="hidden" name="GOODS_ID" id="GOODS_ID" value="${pd.GOODS_ID}"/>
		<input type="hidden" name="location" id="location" value="${pd.type}"/>
		<div id="zhongxin">
