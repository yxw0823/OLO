	...
	<form action="createCode/proCode.do" name="Form" id="Form" method="post">
		...
		<table style="margin-top: 10px;" border="0">
			<tr>
				...
				<td colspan="1"><input type="text" name="tabletop" id="tabletop" value="" placeholder="这里输入表名" style="width:370px" title="包名称"/></td>
				<td>多表以丢号分隔 列：table1,table2</td>
			</tr>
			<tr>
		...
		<!-- <table border="0">
			<tr>
				...
				<td style="width:76px;text-align: right;">表名：</td>
				<td><input type="text" name="tabletop" id="tabletop" value="" placeholder="这里输入表名"  style="width:200px"  title="表前缀"/></td>
			</tr>
		</table> -->
		<!-- 
