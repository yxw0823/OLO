...
<body>
	<form  action="dictionaries/save.do" name="Form" id="Form" method="post"  enctype="multipart/form-data">
		...
		<table>
			<tr>
				<td>
				<input type="hidden" name="PATH" id="PATH" value="${pd.PATH}" placeholder="这里输入图片路径" title="图片路径"/>
			 	<c:if test="${pd.PATH != '' && pd.PATH != null }">
						<img src="${pd.imgBasePath}/${pd.PATH}" />
				</c:if> 
