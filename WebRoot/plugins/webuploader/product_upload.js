...
(function( $ ){
    ...
    $(function() {
        ...
        uploader.on( 'uploadSuccess', function( file,response  ) {
        	...
        	console.log(  $(uploaderId).parent().attr("id"));
        	var imagesDiv = $("#imagesDiv");
        	if(imagesDiv != null){
        		imagesDiv.append("<input type='hidden' name='"+$(uploaderId).parent().attr("id")+"' value='"+response.img.PATH+"'/>")
        	}
        	console.log(imagesDiv.html());
            // do some things.
        });
