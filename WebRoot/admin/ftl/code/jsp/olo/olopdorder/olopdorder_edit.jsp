...
<body>
	<form action="olopdorder/${msg }.do" name="Form" id="Form" method="post">
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			...
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">下单人员ID:</td>
				<td><input type="text" name="USER_ID" id="USER_ID" value="${pd.USER_ID}" maxlength="32" placeholder="这里输入下单人员ID" title="下单人员ID"/></td>
			</tr>
			<tr>
