...
public class Page {
	...
	public void addListSort(List<Map<String,String>> list) {
	    List<Sort> sort= new ArrayList<Page.Sort>();
	    for(Map<String,String>map:list){
	        if(!StringUtils.isEmpty(map.get("name")))
	        {
	            Sort    sort1 = new Sort();
	            sort1.setName(map.get("name"));
	            sort1.setSortStr(map.get("sortStr")== null ? "":map.get("sortStr"));
	            sort.add(sort1);
	        }
	    }
        this.sort = sort;
