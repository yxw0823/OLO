...
public class AppUtil  {
	...
	public static boolean checkParam(String method, PageData pd){
		...
		}else if(method=="webappLogin"){//根据用户名获取会员信息
            paramArray = Const.APP_WEBAPPLOGIN_PARAM_ARRAY;  
            valueArray = Const.APP_WEBAPPLOGIN_VALUE_ARRAY;
        }
...
//			String	 return_JSONP = callback + "(" + JSONObject.fromObject(map)  + ");";
//			return map;
