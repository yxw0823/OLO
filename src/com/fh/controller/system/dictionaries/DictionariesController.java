...
public class DictionariesController extends BaseController {
	...
	public ModelAndView save(@RequestParam Map<String,String> map,@RequestParam(required = false,value="file") MultipartFile file,PrintWriter out) throws Exception{
