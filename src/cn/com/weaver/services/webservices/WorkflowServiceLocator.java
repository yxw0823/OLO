...
public class WorkflowServiceLocator extends org.apache.axis.client.Service implements cn.com.weaver.services.webservices.WorkflowService {
    ...
    private java.lang.String WorkflowServiceHttpPort_address = "http://service.olokitchen.com//services/WorkflowService";
    ...
    public cn.com.weaver.services.webservices.WorkflowServicePortType getWorkflowServiceHttpPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cn.com.weaver.services.webservices.WorkflowServiceHttpBindingStub _stub = new cn.com.weaver.services.webservices.WorkflowServiceHttpBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (cn.com.weaver.services.webservices.WorkflowServicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                cn.com.weaver.services.webservices.WorkflowServiceHttpBindingStub _stub = new cn.com.weaver.services.webservices.WorkflowServiceHttpBindingStub(new java.net.URL(WorkflowServiceHttpPort_address), this);
                _stub.setPortName(getWorkflowServiceHttpPortWSDDServiceName());
                return _stub;
            }
        }
